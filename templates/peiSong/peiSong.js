...
document.addEventListener('DOMContentLoaded', function() {
  var deIdElement = document.getElementById('deId');
  var deId = deIdElement ? deIdElement.textContent : null;
  if (deId) {
    console.log('DeId:', deId);
    connectWebSocket(deId);
  } else {
    console.error('DeId element not found');
  }
});
